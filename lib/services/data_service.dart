...
class DataService extends ChangeNotifier {
  ...
  /// Save backup to local Downloads folder.
  /// REPLACES the previous backup file (fixed name) so storage doesn't fill up.
  Future<String> saveBackupToFile() async {
    ...
    // Fixed filename — always overwrites the old backup
