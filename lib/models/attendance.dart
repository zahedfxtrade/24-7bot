class AttendanceRecord {
  ...
  String? cancelReason;
  // For partial PP cancel: amount to pay for the remaining single shift
  // SD guard: remaining overtime amount after one shift cancelled
  // DD guard: amount agreed for the one remaining shift
  int cancelledShiftAmount;
  ...
  Map<String, dynamic> toJson() => {
        ...
        'cancelledShiftAmount': cancelledShiftAmount,
      };
  ...
  factory AttendanceRecord.fromJson(Map<String, dynamic> json) =>
      AttendanceRecord(
        ...
        cancelledShiftAmount: json['cancelledShiftAmount'] ?? 0,
      );
}
